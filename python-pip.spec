...
Version:        6.1.0
Release:        0.68.20150707git685c8b5a%{?dist}
Summary:        A tool for installing and managing Python packages

Group:          Development/Libraries
License:        MIT
URL:            http://www.pip-installer.org
Source0:        python3-nightly-pip-685c8b5a.tar
...
%changelog
* Tue Jul 07 2015 Miro Hrončok <mhroncok@redhat.com> - 6.1.0-0.68.20150707git685c8b5a
- Update to git: 685c8b5a

* Sat Jul 04 2015 Miro Hrončok <mhroncok@redhat.com> - 6.1.0-0.67.20150704gita767bac9
- Update to git: a767bac9

* Thu Jul 02 2015 Miro Hrončok <mhroncok@redhat.com> - 6.1.0-0.66.20150702git537369c4
- Update to git: 537369c4
